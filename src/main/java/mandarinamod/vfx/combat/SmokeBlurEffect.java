...
public class SmokeBlurEffect extends AbstractGameEffect {
    ...
    public SmokeBlurEffect(float x, float y) {
        ...
        this.color.r = MathUtils.random(0.3F, 0.4F);
        this.color.g = MathUtils.random(0.2F, 0.4F);
        this.color.b = MathUtils.random(0.3F, 0.45F);
        ...
        this.y = y + MathUtils.random(50.0F * Settings.scale, 250.0F * Settings.scale) - (float)this.img.packedHeight / 2.0F;
        this.scale = 0.01F;
