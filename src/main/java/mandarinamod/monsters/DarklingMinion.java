...
public class DarklingMinion extends AbstractIntentFriendlyMonster {
    public static final String MONSTER_ID = MandarinaMod.makeID(DarklingMinion.class.getSimpleName());
