...
@SpireInitializer
public class MandarinaMod implements
        EditCardsSubscriber,
    ...
    private static String checkResourcesPath() {
        String name = MandarinaMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        if (!resources.exists()) {
            throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                    ...
                    "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                    "\tat the top of the " + MandarinaMod.class.getSimpleName() + " java file.");
        }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(MandarinaMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        Mandarina.Meta.registerCharacter();
    }
...
//        BaseMod.addPotion(BuildAFunctionPotion.class, Color.FIREBRICK, Color.GRAY, Color.TAN, BuildAFunctionPotion.POTION_ID, AutomatonChar.Enums.THE_AUTOMATON);
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.addEvent(new AddEventParams.Builder(TheOrchard.ID, TheOrchard.class) //Event ID//
                //Event Character//
                .playerClass(Mandarina.Meta.MANDARINA)
